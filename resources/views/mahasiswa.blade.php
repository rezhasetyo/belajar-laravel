...
<body>
    ...
    <div class="container" style="background-color:white;">
        <h2>Mahasiswa</h2>
        <p>Berisi data dari mahasiswa berikut ini :</p>
        <table class="table table-hover">
            ...
            <tbody>
              ...
              <tr>
                <td>Dosen</td>
                <td>Aisyatul Karima, S.Kom., MCS.</td>
              </tr>
            </tbody>
        </table>
    ...
    <!--MahasiswaCatch-->
    <br> <br> <center>
    <h1 class="display-4"><strong>TUGAS VIEW</strong></h1>
    <p class="lead"><center>Silahkan Click Link di bawah untuk menuju Rudi dan Lisa</center></p>
    <a class="btn btn-secondary btn-lg" href="http://localhost:8000/mahasiswa/Rudi/24/Jakarta" role="button"> Rudi</a>    
    <a class="btn btn-info btn-lg" href="http://localhost:8000/mahasiswa/Lisa/19/Bandung" role="button"> Lisa</a>
    </center> <br>
